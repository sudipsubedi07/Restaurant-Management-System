					...
					<div class="col-md-12">
						...
						<div class="below-toggle-content">
							<div class="col-md-12">
								...
								<div class="row">
									<form method="POST" action="add_menu_be.php" class="p-3" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
									    	...
									    	<input type="text" name="phone" class="form-control shadow-none" id="phone" placeholder="Enter Phone No">
									  	</div>
                      <div class="form-group">
