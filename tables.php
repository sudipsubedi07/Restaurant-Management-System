...
<table class="table table-striped" id="category_table">
    ...
    ?>
                <tr>
                    ...
                    <td>
						<a href="edit-table.php?" class="btn btn-primary" role="button">Edit</a>
						<a href="delete-table.php" onclick="showDelete(<?php echo $data['id'] ?>);" class="btn btn-danger" role="button">Delete</a>
					</td>
